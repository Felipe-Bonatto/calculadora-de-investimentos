  ...
  doughnutChartReference = new Chart(finalMoneyChart, {
    ...
    data: {
      ...
      datasets: [
        {
          data: [
            formatCurrencyToGraph(finalInvestmentObject.investedAmound),
      ...
      datasets: [
        {
          ...
          data: returnsArray.map((investmentObject) =>
            formatCurrencyToGraph(investmentObject.investedAmound)
          ),
...
const casouselEl = document.getElementById("carousel");
const nextButton = document.getElementById("slide-arrow-next");
const previousButton = document.getElementById("slide-arrow-previous");

nextButton.addEventListener("click", () => {
  casouselEl.scrollLeft += mainEl.clientWidth;
});
